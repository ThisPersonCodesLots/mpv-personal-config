...
-- fork by https://github.com/mltorr/mpv-everforest/tree/main
...
local user_opts = {
    ...
    fadeduration = 2000,         -- duration of fade out in ms, 0 = no fade
...
function update_margins()
    ...
    mp.set_property_native("user-data/osc/margins", string.format("%f,%f,%f,%f", margins.l, margins.r, margins.t, margins.b))
end
